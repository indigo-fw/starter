...
import { User, Settings, Shield, CreditCard, LifeBuoy, Link2, ShoppingBag, Heart, MapPin } from 'lucide-react';
...
export function AccountNav() {
  ...
  const items = [
    ...
    { href: accountRoutes.addresses, label: __('Addresses'), icon: MapPin },
