  ...
  const characters = [
    {
      ...
      genderId: 1,        // woman
      ethnicityId: 1,     // white
      personalityId: 6,   // romantic-lover
      kinkId: 1,          // vanilla
      jobId: 17,          // artist
      hobbies: [3, 5, 6], // reading, drawing, photography
      relationshipId: 10,  // friend
      hairColorId: 1,     // (will map to first hair color entry)
      isActive: true,
      sortOrder: 0,
    },
    {
      ...
      genderId: 2,        // man
      ethnicityId: 1,     // white
      personalityId: 1,   // dominant
      kinkId: 1,          // vanilla
      jobId: 4,           // CEO
      hobbies: [14, 3],   // puzzles, reading
      relationshipId: 4,  // mentor
      isActive: true,
      sortOrder: 1,
    },
    {
      ...
      ethnicityId: 4,     // asian
      personalityId: 8,   // wise-and-confidant
      kinkId: 1,          // vanilla
      jobId: 15,          // therapist
      hobbies: [7, 3, 4], // meditation, reading, writing
      relationshipId: 4,  // mentor
      isActive: true,
      sortOrder: 2,
    },
