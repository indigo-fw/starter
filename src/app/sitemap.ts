...
import { MODULE_SITEMAP_FETCHERS } from '@/generated/module-sitemap';
...
const CONTENT_FETCHERS: SitemapFetcher[] = [
  ...
  // Module-contributed fetchers (authors, store, …) — declared in each
  // module's `module.config.ts` (`sitemapFetchers`) and generated by
  // `indigo:sync`, so removing a module never leaves a dangling import here.
  ...MODULE_SITEMAP_FETCHERS,
];
